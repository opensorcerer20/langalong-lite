...
export const STATION_ITEMS: readonly SentenceItem[] = [
  {
    ...
    tags: { particles: ['made', 'o'], conjugations: [] },
  },
  {
    id: '02',
    ...
    tags: { particles: ['wa'], conjugations: [] },
  },
  {
    id: '03',
    ...
    tags: { particles: ['ni'], conjugations: ['masu'] },
  },
  {
    id: '04',
    ...
    tags: { particles: ['no', 'ni'], conjugations: ['masu'] },
  },
  {
    id: '05',
  ...
  },
  {
    ...
    tags: { particles: ['wa'], conjugations: ['potential', 'masu'] },
  },
  {
    id: '08',
    ...
    tags: { particles: ['ni', 'e'], conjugations: ['tai'] },
  },
];
