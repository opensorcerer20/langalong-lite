...
| **Vitest** + **Testing Library** | 374 tests |
...
374 tests, across every component and module. Two are load-bearing: `tests/lib/buildBank.test.ts` checks the deterministic tile bank against all 18 banks as the original prototype generated them, and `tests/components/App.test.tsx` plays real drills through the real content. Detail in [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md#tests).
